...
def create_parser():
    parser = argparse.ArgumentParser(
        description='AgriSTL train/test a model')
    # Set-up parameters
    ...
    parser.add_argument('--skip_test_after_train', action='store_true', default=False,
                        help='Skip the final test phase after training finishes')
    ...
    parser.add_argument('--dataname', '-d', default='mmnist', type=str,
                        choices=['bair', 'mfmnist', 'mmnist', 'mmnist_cifar', 'noisymmnist', 'taxibj', 'human',
                                ...
                                'sevir_vis', 'sevir_ir069', 'sevir_ir107', 'sevir_vil', 'namin', 'yield'],
    ...
    parser.add_argument('--method', '-m', default='PredFormer', type=str,
                        choices=['ConvLSTM', 'convlstm', 'E3DLSTM', 'e3dlstm', 'MAU', 'mau', 'MIM', 'mim', 
                                ...
                                'TimesNet', 'timesnet', 'iTransformer', 'itransformer',
                                'TimeMixer', 'timemixer', 'TimeSformer', 'timesformer', 'DMVFN', 'dmvfn',
                                'PredFormer', 'predformer', 'Yield3DCNN', 'yield3dcnn',
                                'VMRNN', 'vmrnn', 'vmrnn_d', 'vmrnn_b', 'GMG', 'gmg'],
