import torch
from openstl.models import GMG_Model
from openstl.utils import (reshape_patch, reshape_patch_back,
                           reserve_schedule_sampling_exp, schedule_sampling)
from .base_method import Base_method


class GMG(Base_method):
    r"""GMG

    Implementation of `GMG: Global Motion Guided Spatiotemporal Predictive Learning`.
    ...
    def _build_model(self, **args):
        ...
        att_hidden = self.hparams.att_hidden
        return GMG_Model(num_layers, num_hidden, att_hidden, self.hparams)
